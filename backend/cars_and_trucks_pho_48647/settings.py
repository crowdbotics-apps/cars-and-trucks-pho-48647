"""
Django settings for cars_and_trucks_pho_48647 project.
...
ROOT_URLCONF = 'cars_and_trucks_pho_48647.urls'
...
WSGI_APPLICATION = 'cars_and_trucks_pho_48647.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "Cars and Trucks photos Support <support@cars-and-trucks-pho-48647.botics.co>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "cars_and_trucks_pho_48647 API",
    "DESCRIPTION": "API documentation for cars_and_trucks_pho_48647 App",
    "VERSION": "v1",
}
